...
parentid <- c(101,102,103,101,103,101,101,101,103,103,104,105)
...
CUSTOMER <- CUSTOMER %>% select(customer_id:membership)
```
...
SHIPMENT_address <- SHIPMENT_address %>% select(saddress_id, shipment_id:postcode)
...
SHIPMENT <- SHIPMENT %>% select(shipment_id:shipment_status)
...
SUPPLIER_address <- SUPPLIER_address %>% select(supaddress_id, supplier_id:postcode)
# Filled missing value in postcode
...
SUPPLIER <- SUPPLIER %>% select(supplier_id:supplier_phone)
